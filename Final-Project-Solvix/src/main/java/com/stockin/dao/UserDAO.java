...
public class UserDAO {
    ...
    private User mapRow(ResultSet rs) throws Exception {
        ...
        // Membuat instance Owner atau Staff (bukan class User polos) sesuai
        // kolom role di database, lewat factory method di User.
        User user = User.createByRole(rs.getString("role"));
